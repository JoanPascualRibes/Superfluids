...
\todo{Introduction (basic properties)}
...
\todo{Aquí referencio dinámica de fluidos, quizá colocar esta sección después}
...
Project Dedalus is a flexible framework for spectrally solving differential equations. We used tis framework to spectrally solve the equations of our model over periodic 2D space.
...
As the simulation advances, we can clearly see how the density wave travels faster than the entropy wave.
