...
\begin{abstract}
\todo{Write abstract}
% We look at superfluid helium, how it was discovered and some of its major properties.  Quantum physics helps us explain these phenomena through Bose-Einstein condensation.  We build a superfluid simulation and draw conclusions.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{Images/CondensateFraction.png}
...
\section{Eki Parte}
\todo{Hay que reframear esta parte un poco, ya que hemos explicado la cuántica al principio}
...
\todo{Por el amor de dios mejorar la acalidad de imagen}
...
However, the classical example of the $\lambda$-point of liquid helium does not seem to admit an explanation in terms of any mechanism of this kind; the helium atoms are just too symmetrical to achieve an order-disorder transition, say, by virtue of an orientation like that of the \ce{NH_4} tetrahedra of the ferromagnetic dipole alignment. Nor can a pure substances like helium establish anything like the type or order of binary alloys. Liquid helium seems to be too simple to have a $\lambda$-point!
\\

By examining the phase diagram on P-T plane, we can observe more conspicuous properties. Probably the most striking one might be the absence of a triple point between the solid, liquid and gaseous states. Instead are actually two triple points, at the ends of the $\lambda$-line which separates liquid \ce{He} I from \ce{He} II\@.
\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{Images/creep.png}
...
\begin{figure}[h]
    \includegraphics[width=\textwidth/2]{Sim 3/SF01_0000.png}
    \includegraphics[width=\textwidth/2]{Sim 3/SF01_0005.png}
    \includegraphics[width=\textwidth/2]{Sim 3/SF01_0010.png}
    \includegraphics[width=\textwidth/2]{Sim 3/SF01_0015.png}
    \includegraphics[width=\textwidth/2]{Sim 3/SF01_0020.png}
    \includegraphics[width=\textwidth/2]{Sim 3/SF01_0025.png}
    \caption{Snapshots from simulation 3}
    \label{sim3}
\end{figure}

\subsubsection{Simulation 4: Standing waves}
In this simulation we set the velocity field to \(\mathbf{v} = (0.1\cos(y), -0.1\cos(x))\) and found that both the density and the entropy fields oscillate in a certain pattern. If we measure the frequency of these oscillations, the density field has a frequency of around 8.8 Hz and the entropy field has a frequency of around 4 Hz. \todo{justify \(\lambda = \sqrt{2} \pi\)} then we find that the velocity of the waves in the density field is 39 m/s and the velocity of the entropy waves is 17.7 m/s. This result agrees with the known speeds of the first sound (40 m/s) and the second sound (18.8 m/s).
...
\begin{figure}[h]
    \includegraphics[width=\textwidth/2]{Sim 4/SF01_0000.png}
    \includegraphics[width=\textwidth/2]{Sim 4/SF01_0010.png}
    \includegraphics[width=\textwidth/2]{Sim 4/SF01_0020.png}
    \includegraphics[width=\textwidth/2]{Sim 4/SF01_0030.png}
    \includegraphics[width=\textwidth/2]{Sim 4/SF01_0040.png}
    \includegraphics[width=\textwidth/2]{Sim 4/SF01_0050.png}
...
\begin{figure}[h]
    \includegraphics[width=\textwidth/2]{Sim 5/SF01_0000.png}
    \includegraphics[width=\textwidth/2]{Sim 5/SF01_0050.png}
    \includegraphics[width=\textwidth/2]{Sim 5/SF01_0100.png}
    \includegraphics[width=\textwidth/2]{Sim 5/SF01_0150.png}
    \includegraphics[width=\textwidth/2]{Sim 5/SF01_0200.png}
    \includegraphics[width=\textwidth/2]{Sim 5/SF01_0250.png}
...
\todo{Why is our conclusion about supersolids?}
 \todo{No sé on posar-lo, volia mencionar-ho}
...
\todo{Añadir origenes de las imágenes}
\todo{}
