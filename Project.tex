...
In 1908 Kamerlingh Onnes liquefied helium for the first time at a critical temperature of 5.2ºK, and as the temperature was lowered, he found that when the liquid is cooled below 2.2ºK it starts expanding instead of continuing to contract, thus deviating from the behaviour of more substances.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\linewidth]{Density.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\linewidth]{LambdaCp.png}
...
\begin{figure}[H]
    ...
    \begin{tabular}{cc}
        \begin{subfigure}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{CuriePoint.png}
            \caption{Specific heat as a function of temperature showing the peak at the Curie point.}
            \label{fig:enter-label}
        \end{subfigure} &
        \begin{subfigure}{0.5\textwidth}
            \centering
            \includegraphics[width=\linewidth]{AmmoniumChloride.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{PhaseDiagr.png}
